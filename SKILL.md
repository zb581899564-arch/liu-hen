...
本地命令可按下列逻辑理解：
- `create-ex` 对应 `python tools/skill_writer.py --action create --base-dir <repo>/exes`
- `list-exes` 对应 `python tools/skill_writer.py --action list --base-dir <repo>/exes`
- `ex-rollback` 对应 `python tools\version_manager.py --action rollback --base-dir <repo>/exes`
