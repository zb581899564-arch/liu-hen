...
test('canSendProactiveContinuation stops after a few unanswered assistant messages', () => {
  assert.equal(canSendProactiveContinuation([
    { kind: 'message', role: 'assistant', text: '在吗' },
    { kind: 'message', role: 'assistant', text: '刚想起来' },
    { kind: 'message', role: 'assistant', text: '算了你忙吧' },
  ]), false);

  assert.equal(canSendProactiveContinuation([
    { kind: 'message', role: 'assistant', text: '在吗' },
    { kind: 'message', role: 'user', text: '怎么啦' },
    { kind: 'message', role: 'assistant', text: '没事' },
  ]), true);
});
